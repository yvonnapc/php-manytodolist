<?php
    ...
    $app->patch("categories/{id}", function($id) use ($app) {
        ...
        return $app['twig']->render('category.html.twig', array('category' => $category, 'tasks' => $category->tasks()));
    });
    ...
    $app->post("/add_tasks", function() use ($app) {
        ...
        return $app['twig']->render('category.html.twig', array('category' => $category, 'categories' => Category::getAll(), 'tasks' => $category->tasks(), 'all_tasks' => Task::getAll()));
    });
    ...
    $app->post("/add_categories", function() use($app){
      ...
      return $app['twig']->render('task.html.twig', array('task' => $task, 'tasks' => Task::getAll(), 'categories' => $task->categories(), 'all_categories' => Category::getAll()));
    });
